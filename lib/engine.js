      ...
      if (!s.acted_on_stop) {
        if (last_trade.type === 'buy') {
          if (do_sell_stop && s.sell_stop && s.period.close < s.sell_stop) {
            ...
            pushMessage('Sell stop triggered at ' + s.last_trade_worth + ' trade worth\n')
          }
          ...
          if (s.profit_stop && s.period.close < s.profit_stop && s.last_trade_worth > 0) {
            ...
            pushMessage('Profit stop triggered at ' + s.last_trade_worth + ' trade worth\n')
          }
        }
        else {
          if (s.buy_stop && s.period.close > s.buy_stop) {
            ...
            pushMessage('Buy stop triggered at ' + s.last_trade_worth + ' trade worth\n')
          }
        }
      }
    }
