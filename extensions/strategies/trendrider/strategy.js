  ...
  module.exports = {
      ...
      //console.log(s.period)
		  if(s.period.lower && s.period.upper) {
			  ...
			  cols.push(z(8, n(upperBound).format('0.00000000').substring(5,10), ' ').red)
			  cols.push(' ')
        cols.push(z(8, n(s.period.ema).format('0.00000000').substring(5,10), ' ').white)
        cols.push(' ')
			  cols.push(z(8, n(lowerBound).format('0.00000000').substring(5,10), ' ').green)
		  } else {
